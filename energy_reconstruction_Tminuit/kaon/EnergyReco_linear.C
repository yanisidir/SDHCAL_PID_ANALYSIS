...
void EnergyReco_linear() {
    ...
    TFile* fHits   = TFile::Open("data/130k_kaon_E1to130_digitized.root");
    TFile* fEnergy = TFile::Open("data/130k_kaon_E1to130.root");
    if (!fHits || !fEnergy) {
    ...
    leg.Draw();
    c1.SaveAs("plots/Reco_vs_Beam_lineaire_kaon.pdf");
    ...
    c2.SaveAs("plots/Profil_linearite_lineaire_kaon.pdf");
    ...
    gRes.Draw("APL");
    c3.SaveAs("plots/Resolution_relative_lineaire_kaon.pdf");
}
