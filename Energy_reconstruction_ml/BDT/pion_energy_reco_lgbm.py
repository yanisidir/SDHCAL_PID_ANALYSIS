...
PARAMETERS_FILE = Path("run_parameters_regression_pi.csv")
COMMENTS_FILE = Path("run_comments_regression_pi.csv")
PERF_FILE = Path("hadron_energy_performances_pi.csv")
...
def init_run(config: Config) -> tuple[int, Dict[str, Path]]:
    ...
    paths = {
        "model": RES_DIR / "models" / f"lgbm_regressor_pi_{run_id}.joblib",
        "scaler": RES_DIR / "models" / f"scaler_pi_{run_id}.joblib",
